 ...
 * Modern, intuitive document review interface following Google Docs/Notion patterns
 * Provides contained scrolling and focused document experience
 */
...
export function DocumentReviewContainer({
  title,
  children,
  onSave,
  onCancel,
